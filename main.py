...
def zdh4():
    s = ["Финкельберг","Гумерова","Телятникова","Назаренко","Рахимов","Шамбурова","Шенфельд","Тарнаева","Жарко","Ахмедов"]
    s1 = ["Павлова","Денисов","Куокканен","Литвина","Перцева","Игнатьев","Мунтян","Ясюкевич","Шабельская","Григорчук"]
